...
COPY public."LogActions" (id, action, "userId", "createdAt", "updatedAt") FROM stdin;
\.
...
5	Admin Test	admin@test.com	$2b$10$scLA4cZThU68Vj8RL0P4xOReii9JC/NhTc9IyTocmncuVvLT8UINO	administrador	f	\N	2025-11-26 17:42:39.487-04	2025-11-26 17:42:39.487-04
6	Teacher Test	teacher@test.com	$2b$10$Gr9hUItFumpeFi9872lElOfmE1Gfh6TSO0RX0gqRTIKFuGp1Z7aoW	docente	f	\N	2025-11-26 17:42:39.6-04	2025-11-26 17:42:39.6-04
\.
...
--
-- Name: LogActions LogActions_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."LogActions"
    ADD CONSTRAINT "LogActions_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."Users"(id) ON UPDATE CASCADE ON DELETE CASCADE;
